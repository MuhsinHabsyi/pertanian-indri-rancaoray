...
<head>
    ...
    <title>Daftar — Toko Beras Rancaoray</title>
    <meta name="description" content="Buat akun baru untuk membeli beras berkualitas dari Tani Rancaoray.">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
            <div class="w-full max-w-sm space-y-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Daftar untuk mulai membeli beras berkualitas.</p>
                </div>
                ...
                <p class="text-center text-sm text-gray-500">
                    Sudah punya akun?
                    <a href="/login" class="font-semibold text-emerald-600 hover:text-emerald-700 transition">Masuk di sini</a>
                </p>
